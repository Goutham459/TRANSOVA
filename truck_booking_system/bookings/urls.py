...
from .views import (  # Driver views; Admin views; User management; FAQ views; New customer features; Payment
    add_booking,
    admin_companies,
    admin_company_approve,
    admin_company_disapprove,
    admin_dashboard,
    admin_drivers,
    admin_faq,
    admin_faq_toggle_public,
    admin_load_type_add,
    admin_load_type_delete,
    admin_load_type_edit,
    admin_load_types,
    ...
    faq_submit,
    home,
    live_tracking_booking,
    payment,
    payment_cancel,
    payment_success,
    process_payment,
    profile,
    submit_company_rating,
)
...
urlpatterns = [
    ...
    path(
        "driver/job/<int:booking_id>/<str:new_status>/",
        driver_update_job_status,
        name="driver_update_job_status",
    ),
    path(
        "driver/job/<int:booking_id>/accept/",
        driver_accept_job,
        name="driver_accept_job",
    ),
    path(
        "driver/job/<int:booking_id>/reject/",
        driver_reject_job,
        name="driver_reject_job",
    ),
    path(
        "driver/job/<int:booking_id>/proof/",
        driver_delivery_proof,
        name="driver_delivery_proof",
    ),
    ...
    path(
        "admin/users/<int:user_id>/delete/", admin_user_delete, name="admin_user_delete"
    ),
    path("admin/trucks/", admin_trucks, name="admin_trucks"),
    path("admin/trucks/add/", admin_truck_add, name="admin_truck_add"),
    path(
        "admin/trucks/<int:truck_id>/edit/", admin_truck_edit, name="admin_truck_edit"
    ),
    path(
        "admin/trucks/<int:truck_id>/delete/",
        admin_truck_delete,
        name="admin_truck_delete",
    ),
    path("admin/companies/", admin_companies, name="admin_companies"),
    path(
        "admin/companies/<int:company_id>/approve/",
        admin_company_approve,
        name="admin_company_approve",
    ),
    path(
        "admin/companies/<int:company_id>/disapprove/",
        admin_company_disapprove,
        name="admin_company_disapprove",
    ),
    ...
    path(
        "admin/load-types/<int:load_type_id>/edit/",
        admin_load_type_edit,
        name="admin_load_type_edit",
    ),
    path(
        "admin/load-types/<int:load_type_id>/delete/",
        admin_load_type_delete,
        name="admin_load_type_delete",
    ),
    path("admin/subscriptions/", admin_subscriptions, name="admin_subscriptions"),
    path(
        "admin/subscriptions/<int:subscription_id>/toggle/",
        admin_subscription_toggle,
        name="admin_subscription_toggle",
    ),
    ...
    path(
        "admin/faq/<int:question_id>/toggle-public/",
        admin_faq_toggle_public,
        name="admin_faq_toggle_public",
    ),
    # New Customer Feature URLs
    path("profile/", profile, name="profile"),
    path("bookings/receipt/<int:booking_id>/", booking_receipt, name="booking_receipt"),
    path(
        "bookings/receipt/<int:booking_id>/download/",
        download_receipt_pdf,
    ...
    path(
        "track/<int:booking_id>/", live_tracking_booking, name="live_tracking_booking"
    ),
    path(
        "rate-company/<int:company_id>/",
        submit_company_rating,
        name="submit_company_rating",
    ),
    # Payment processing
